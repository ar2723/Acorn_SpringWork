...
@Service
public class ClassCafeServiceImpl implements ClassCafeService{
	...
	public void getList(HttpServletRequest request) {
		//한 페이지에 몇개씩 표시할 것인지
	      ...
	      */
	      ...
	      List<ClassCafeDto> list = classCafeDao.getList(dto);
	      
	      //전체 글의 갯수(검색 키워드가 있는경우 키워드에 부합하는 전체 글의 갯수)
	      int totalRow = classCafeDao.getCount(dto);
	...
	public void addLikeCount(HttpServletRequest request) {
		...
		classCafeDao.addLikeCount(num);
	}
	
	@Override
	public void getDetail(HttpServletRequest request) {
		int num = Integer.parseInt(request.getParameter("num"));
		classCafeDao.addViewCount(num);
		 ...
		 */
	     ...
	     //글하나의 정보를 얻어온다.
	     ClassCafeDto resultDto = classCafeDao.getData(dto);
	...
	public void saveContent(ClassCafeDto dto) {
		...
		classCafeDao.insert(dto);
	}

	@Override
	public void updateContent(ClassCafeDto dto) {
		classCafeDao.update(dto);
	}

	@Override
	public void deleteContent(int num, HttpServletRequest request) {
		//번호에 해당하는 글의 정보를 얻어와서
		ClassCafeDto dto = classCafeDao.getData(num);

...
public class MyInterceptor implements HandlerInterceptor{
	...
	//요청-응답 흐름에서 DispatcherServlet과 Controller 중간에 간섭
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		request.setAttribute("msg", "나는 인터셉터입니다 ㅎㅇ");
	...
	//요청-응답 흐름에서 Controller에서 jsp로 리턴되는 중간에 간섭
	@Override
	...
	//응답한 이후에 호출되는 메소드
	//요청-응답 흐름에서 jsp가 클라이언트에게 응답 후에 호출됨
	@Override

...
<body>
	<jsp:include page="/WEB-INF/views/include/navbar.jsp">
		<jsp:param value="gallery_list" name="current"/>
	</jsp:include>
	<div class="container mb-2">
	      <h3 class="text-center">갤러리 목록 입니다.</h3>
	      <div class="row">
	      ...
	      <div class="d-flex justify-content-end mb-2">
		      <a class="me-2" href="${pageContext.request.contextPath}/gallery/upload_form">사진 업로드</a>
		      <a class="me-2" href="${pageContext.request.contextPath}/gallery/upload_form2">사진 업로드2</a>
		      <a href="${pageContext.request.contextPath}/gallery/upload_form3">사진 업로드3</a>
	      </div>
	      <nav>
